...
const isFormValid = computed(() =>
    form.title.trim().length > 0 && form.author_id !== ''
)
                ...
                <div class="modal-content">
                    <form @submit.prevent="submit">
                        <div class="modal-header">
                            <h5 class="modal-title">Pridať knihu</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-check mb-3">
                                <input v-model="form.is_borrowed" class="form-check-input" type="checkbox" id="isBorrowed" />
